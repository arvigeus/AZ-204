                      ...
                      <li key={index} className="mb-2">
                        <label
                          className={clsx(
                            ...
                            showAnswer && data.answerIndexes.includes(index)
                              ? "bg-green-200"
                              : "bg-transparent"
                          )}
                        >
                  ...
                  <div className="flex flex-row">
                    ...
                    <div className="relative">
                      <button
                        ...
                        className={clsx(
                          isLoading
                            ? "text-gray-900 bg-white hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-blue-700 font-medium rounded-r-lg focus:text-blue-700 pr-4 py-2.5 text-center inline-flex items-center dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                            : "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-r-lg text-sm pr-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        )}
                        type="button"
                        disabled={isLoading}
                      >
